...
export const caseStudy: CaseStudyLayout3 = {
  ...
  galleryShots: [
    ...
    { label: "SPC Fair Booth Setup", gradient: NIGHT_GRADIENTS[4], image: `${IMG}/presentation-5.png`, category: "Site" },
    { label: "Sahapat Delivery Booth Setup", gradient: NIGHT_GRADIENTS[1], image: `${IMG}/presentation-11.png`, category: "Site" },
  ...
  techStack: [
    ...
    { name: "Microsoft Office", image: "image%20(45).png" },
    { name: "Safetica" },
  ],
};
