...
export const TH_HOME = {
  settings: {
    ...
    "home.about.body":
      "จากจุดเริ่มต้นในสาย Infrastructure สู่ความสนใจด้าน Development ทุกประสบการณ์ทำให้ผมได้เรียนรู้วิธีคิดและทักษะใหม่ ๆ อยู่เสมอ มาทำความรู้จักกับเส้นทาง แนวคิด และสิ่งที่ผมกำลังพัฒนาต่อได้",
    "skills.summary":
...
export const TH_CONTACT = {
  ...
  resources: {
    ...
    links: [
      { label: "GitHub", sub: "ที่เก็บซอร์สโค้ด" },
      { label: "Email", sub: "ติดต่อโดยตรง" },
      { label: "CV", sub: "ดาวน์โหลด CV" },
      { label: "Resume", sub: "ดาวน์โหลด Resume" },
      { label: "Portfolio", sub: "ดาวน์โหลดพอร์ตโฟลิโอ" },
    ],
